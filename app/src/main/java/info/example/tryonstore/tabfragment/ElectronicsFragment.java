...
RecyclerView product_electorics;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       product_electorics=root.findViewById(R.id.product_electronic);
        ...
        product_electorics.setLayoutManager(mmmLayoutManager);
        product_electorics.addItemDecoration(new GridSpacingItemDecoration(2, dpToPx(10), true));
        product_electorics.setItemAnimator(new DefaultItemAnimator());
        prepareAlbums();
        return root;
        ...
        fstore.collection("best sellings").addSnapshotListener(new EventListener<QuerySnapshot>() {
            ...
            public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                for (DocumentSnapshot snapshot : value) {
                    ...
                    product_electorics.setAdapter(adapter);
