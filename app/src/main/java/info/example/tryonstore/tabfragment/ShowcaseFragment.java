...
public class ShowcaseFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       product_showcase=root.findViewById(R.id.product_showcase);
        ...
        product_showcase.setLayoutManager(mmmLayoutManager);
        product_showcase.addItemDecoration(new GridSpacingItemDecoration(2, dpToPx(10), true));
        product_showcase.setItemAnimator(new DefaultItemAnimator());
        prepareAlbums();
        return root;
    }
        ...
        fstore.collection("best sellings").addSnapshotListener(new EventListener<QuerySnapshot>() {
            ...
            public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                for (DocumentSnapshot snapshot : value) {
                    ...
                    product_showcase.setAdapter(adapter);
