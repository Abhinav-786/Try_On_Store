...
public class FurnitiureFragment extends Fragment {
    RecyclerView product_furniture;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root=inflater.inflate(R.layout.fragment_furnitiure, container, false);
        product_furniture=root.findViewById(R.id.product_furniture);
        ...
        product_furniture.setLayoutManager(mmmLayoutManager);
        product_furniture.addItemDecoration(new GridSpacingItemDecoration(2, dpToPx(10), true));
        product_furniture.setItemAnimator(new DefaultItemAnimator());
        prepareAlbums();
        ...
        fstore.collection("best sellings").addSnapshotListener(new EventListener<QuerySnapshot>() {
            ...
            public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                for (DocumentSnapshot snapshot : value) {
                    ...
                    product_furniture.setAdapter(adapter);
