 package info.example.tryonstore.widget;
...
public class SNavigationDrawer extends RelativeLayout{
    ...
    protected ImageView menuIV,profile1;
    ...
    public void init(Context context){
        ...
        profile1= rootView.findViewById(R.id.profile1);
...
//            Glide.with(SNavigationDrawer.this).load(uri).into(profile1);
//        }else
//        {
//profile1.setBackgroundResource(R.drawable.no_profile_pic);
//        }
